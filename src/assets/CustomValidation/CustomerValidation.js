function AddCustomerValidate()
{
    if(!NameValid())
    {
                   ...
                   swal({   title: "Customer Present",  
                   text: "The Customer is already present in the database.\nTry searching Customer from search.",
                   type: "error",   
                   allowEscapeKey:true,
...
function NameValidation(str)
    {
        ...
        { 
            ...
            return false;
                ...
                var term=str;
                var params="T=CustomerName&Term="+term;
    ...
    function NameValid(){
    var msg = document.getElementById("temp").innerHTML;  
    if(msg!='.'){
        return false;
    }
    else{
